...
public class Refiner {
    ...
    public void relaxQuery(String inputStringOne, String inputStringTwo) {
        ...
        FQAS.relaxed_query = modifiedRelaxedQuery;
    }
    ...
    public static boolean checkCSV(String inputString) {
        ...
        // Initialize the select column. for this dataset num  is the decision attribute.
        String selectColumn = "num";
    ...
    public static void PrintOutput(String inputString) {
        ...
        while (queryOutput.next()) {
            ...
            queryOutputString.append(queryOutput.getRow().getValue(table.getColumnByName("num")));

            // Add a new line char
            queryOutputString.append("\n");
        }
        FQAS.result = queryOutputString.toString();
    }
}
